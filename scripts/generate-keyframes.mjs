...
const KEYS = [
  ...
  { name: "k5_extract", ref: "k4_tamp", prompt: "Espresso extraction: a thick dark stream of espresso with golden crema flowing from the portafilter spout straight down into a small polished stainless-steel milk pitcher (jug) sitting on the dark wooden counter, warm backlight catching the falling stream, faint steam, dark moody background." },
  { name: "k6_crema", ref: "k5_extract", prompt: "Close-up of the same small polished stainless-steel milk pitcher now holding rich dark espresso with a layer of hazelnut-coloured crema rising to the rim, a hand just reaching for the handle, warm light, fine droplets on the steel, dark moody background." },
